...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      {error && (
        <div className="p-4 mb-6 bg-red-50 rounded border-l-4 border-red-500 shadow-sm error-box">
      ...
      {isLoading && (
        <div className="flex justify-center items-center p-6 bg-white rounded-lg shadow loading-container">
          <div className="flex flex-col items-center">
            <svg className="mb-4 w-10 h-10 text-blue-500 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
