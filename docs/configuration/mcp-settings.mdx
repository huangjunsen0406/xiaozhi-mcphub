...
<Tip>
  Looking for more servers? The bundled [Market catalog](https://github.com/huangjunsen0406/xiaozhi-mcphub#readme/features/server-management) in the dashboard lists hundreds of known MCP servers with copy-paste-ready configurations.
</Tip>
