...
```bash
docker run -p 3000:3000 -v $(pwd)/mcp_settings.json:/app/mcp_settings.json huangjunsen/xiaozhi-mcphub
```
...
<CardGroup cols={3}>
  ...
  <Card title="Sponsor" icon="heart" href="https://github.com/huangjunsen0406/xiaozhi-mcphub">
